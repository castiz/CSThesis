...
\begin{figure}
  \includegraphics[scale=0.6]{chan_stolfo.png}
...
\begin{figure}
\centering
  \includegraphics[scale=0.7]{parenclitic.jpg}
...
\begin{figure}
\centering
  \includegraphics[scale=0.7]{parenclitic2.png}
...
\node[on chain=2,init] (sigma) 
  {$\displaystyle\Sigma$};
  \node[on chain=2,squa,label=above:{\parbox{2cm}{\centering Activating \\ function}}]   
  {$f$};
